    ...
    <div className="scr scr-set fade-in" data-screen-label="09 Settings">
      ...
      <div className="set-sec">
        ...
        <div className="set-rows">
          <SetRow ic="🏆" t="Mon club" d={club.name} go={() => go("sync")}/>
          <SetRow ic="👥" t="Mon équipe" d={`${club.team} · 18 joueurs`} go={() => go("effectif")}/>
          <SetRow ic="🔐" t="Compte Google" d="Non connecté (V2.x)" go={() => alert("Auth Google — disponible Sprint 7")}/>
